;; https://raw.github.com/petro-rudenko/Emacs-config/master/python/flymake-customizations.el
...
(global-set-key (kbd "C-x n") 'show-next-flymake-error)
(global-set-key (kbd "C-x p") 'show-prev-flymake-error)
